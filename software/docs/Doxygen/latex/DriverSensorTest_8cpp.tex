...
Open File Descriptor and check if it is non-\/zero Get a remperature reading and make sure it is not below zero(unlikley) or above 50(unlikley) Get a remperature reading and make sure it is not below zero(minimum) or above 100(maxiumum) 